...
public class SystemRuleProvider extends AbstractRuleProvider<SystemRuleEntity> implements InitializingBean {
    ...
    protected String getDataId(String appName) {
        return appName + RuleConfigUtil.SYSTEM_DATA_ID_POSTFIX;
    }
