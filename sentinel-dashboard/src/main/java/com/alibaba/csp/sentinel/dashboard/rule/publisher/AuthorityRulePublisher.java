...
public class AuthorityRulePublisher extends AbstractRulePublisher<AuthorityRuleEntity> implements InitializingBean {
    ...
    protected String getDataId(String app) {
        return app + RuleConfigUtil.AUTHORITY_DATA_ID_POSTFIX;
    }
