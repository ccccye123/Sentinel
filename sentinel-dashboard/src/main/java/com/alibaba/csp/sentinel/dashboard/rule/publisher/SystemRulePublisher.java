...
public class SystemRulePublisher extends AbstractRulePublisher<SystemRuleEntity> implements InitializingBean {
    ...
    protected String getDataId(String app) {
        return app + RuleConfigUtil.SYSTEM_DATA_ID_POSTFIX;
    }
